...
/**
 * 일 1회 워치독 5종 (C1). Authorization: Bearer ${CRON_SECRET} 검사 필수.
 * Hobby 크론은 하루 1회가 상한이고 ±59분 오차가 있습니다 (05_deploy.md 2.2절).
 *
 * ⚠️ 자리 표시자입니다 — 스캐폴딩 단계에서 라우트 파일과 런타임·maxDuration만 잡아 둔 것입니다.
 * 본문은 후속 작업에서 구현합니다. 계약: 05_api_contract.md 4.1절 · 05_deploy.md 5절
 */
